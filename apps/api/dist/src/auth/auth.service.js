...
let AuthService = class AuthService {
    ...
    async validateUser(email, password, userType) {
        ...
        if (userType === login_dto_1.UserType.ADMIN && user.role !== client_1.Role.SUPER_ADMIN) {
            throw new common_1.UnauthorizedException('Admin access required');
        }
        if (userType === login_dto_1.UserType.CUSTOMER && user.role === client_1.Role.SUPER_ADMIN) {
